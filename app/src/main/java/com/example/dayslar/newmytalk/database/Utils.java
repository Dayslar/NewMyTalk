...
public class Utils {
    ...
    public static Record readRecord(Cursor cursor){
        return new Record()
                ...
                .setStartRecord(cursor.getLong(cursor.getColumnIndex(RecordTableConfig.START_RECORDING)))
                .setEndRecord(cursor.getLong(cursor.getColumnIndex(RecordTableConfig.END_RECORDING)))
